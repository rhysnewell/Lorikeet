...
// use estimation::lorikeet_engine::LorikeetEngine;
//
// #[allow(unused)]
...
//     pool.scoped(|scope| {
//
//         LorikeetEngine::begin_tick(0, &progress_bars, &multi_inner, "");
//         LorikeetEngine::begin_tick(1, &progress_bars, &multi_inner, "");
//
...
//                 LorikeetEngine::begin_tick(ref_idx + 2, &progress_bars, &multi_inner, "Preparing variants");
