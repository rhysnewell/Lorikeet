...
mkdir -p dist/lorikeet-x86_64-unknown-linux-musl-$VERSION
cp \
 target/x86_64-unknown-linux-musl/release/lorikeet \
 target/x86_64-unknown-linux-musl/release/remove_minimap2_duplicated_headers \
 INSTALL.md \
 dist/lorikeet-x86_64-unknown-linux-musl-$VERSION/
cd dist
tar czf lorikeet-x86_64-unknown-linux-musl-$VERSION.tar.gz lorikeet-x86_64-unknown-linux-musl-$VERSION
cd ..
